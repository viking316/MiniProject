...
class _MyAppState extends State<MyApp> {
  ...
  final List<Widget> _pages = [
    ...
    BudgetsPage(),
    UserInfoPage(),
    LeaderboardPage(), // Added Leaderboard Page
  ];
              ...
              child: Container(
                ...
                child: BottomNavigationBar(
                  ...
                  items: [
                    ...
                    BottomNavigationBarItem(icon: Icon(Icons.balance_sharp), label: ''),
                    BottomNavigationBarItem(icon: Icon(Icons.person), label: ''),
                    BottomNavigationBarItem(icon: Icon(Icons.leaderboard), label: ''), // Added Leaderboard icon
                  ],
                ),
              ),
            ),
